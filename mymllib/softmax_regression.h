...
namespace myml
{
	...
	private:
		...
		calc_param_type _cur_error = 0;
		calc_param_type _last_error = 0;
		calc_param_type _learning_rate = 1E-3L;
		...
		grad_desc_optimizer<feature_type, label_type, calc_param_type,matrix<calc_param_type>> opt;
	};
